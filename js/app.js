...
var VALOR_ENTREGA = 5; // se mudar colocar ponto, não virgula.. 

var CELULAR_EMPRESA = '5511977294899';
...
cardapio.eventos = {
    ...
    init: () => {
        ...
        cardapio.metodos.carregarWhatsAppButton();
    }
}
...
cardapio.metodos = {
    ...
    //adicionar ao carrinho o item selecionado
    ...
    // atualizar o badge de totais dos botões "Meu Carrinho" // BOTÃO CARRINHO //
    atualizarBadgeTotal: () => {
...
//abrir a modal carrinho
    ...
    // carrega  a lista de itens do caarrinho
    carregarCarrinho: () => {
    ...
    buscarCep: () => {
        ...
        // Expressão regulçar para validar o cep
         var validacep = /^[0-9]{8}$/;
        ...
        if (validacep.test(cep)) {
            ...
            cardapio.metodos.mensagem('Informar o CEP, por favor.');
            $("#txtCEP").focus();
        }
    },
    ...
    //carregar a etapa de resumo do pedido
    carregarResumo: () => {
    ...
    //Atualizar o link do botão WhatsApp
    finalizarPedido: () => {
...
//carregar o link do botão reserva
    ...
    carregarWhatsAppButton: () => {
        ...
        var texto = 'Tudo o que você sempre quis em um só lugar!';
...
// exibir mensagens na tela // MENSAGEM NA TELA
